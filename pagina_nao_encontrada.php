...
<html>
    ...
    <body style="background-color:#242629">
        ...
        <?php
        echo "<div style='text-align:center; margin-top:20%;'  id='demoFont'>Desculpe :( <br><p></p> Essa página não existe.</div> "
    . "<div style='text-align:center; margin-top:24px;'>
        <a href='index.php' class='btn btn-light btn-lg' style='color:black; text-shadow: 1px 1px white; font-weight:bold;'>Voltar para o Início</a>
    </div>";
        ?>
